...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      expandArray: [],                  // double rows of the current row
      branchClosure: false,             // is true if branch is clicked to close
      inputField: [                     // object of all the necessary data to one line
        {
          ...
          checkbox1Confirmed: false,    // if checkbox checked and it becomes permanent
          orangeRuleItem: "",           // symbols stored
          rowNumbers: [],               // line numbers of which line had been closed left side
          rowNumbers2: [],              // line numbers of which line had been closed right side
          firstSet: false,
  ...
  branchClosure = () => {
    ...
    this.state.inputField.map((currentRow, i) => {
        ...
        if (currentRow.checkbox1 && !currentRow.firstSet) {rowNumbers.push(currentRow.fieldNumber, "cb1")} else if (currentRow.checkbox1) {rowNumbers2.push(currentRow.fieldNumber, "cb1")};
        if (currentRow.checkbox2 && !currentRow.firstSet) {rowNumbers.push(currentRow.fieldNumber, "cb2")} else if (currentRow.checkbox2) {rowNumbers2.push(currentRow.fieldNumber, "cb2")};
        if (currentRow.checkbox3 && !currentRow.firstSet) {rowNumbers.push(currentRow.fieldNumber, "cb3")} else if (currentRow.checkbox3) {rowNumbers2.push(currentRow.fieldNumber, "cb3")};
        if (currentRow.checkbox4 && !currentRow.firstSet) {rowNumbers.push(currentRow.fieldNumber, "cb4")} else if (currentRow.checkbox4) {rowNumbers2.push(currentRow.fieldNumber, "cb4")};
        newArray[i] = {...newArray[i], firstSet: true};
        this.state.inputField.map((curRow, j) => {
          if (rowNumbers2.length !== 0) {newArray[j] = {...newArray[j], firstSet: false};}
          return newArray;
        })
    ...
    if (rowNumbers.length === 4) {
      ...
      newArray[rowNumbers[2]-1] = {...newArray[rowNumbers[2] - 1], rowNumbers: rowNumbers, checkbox1: false, checkbox2: false, checkbox3: false, checkbox4: false};
    }
    if (rowNumbers2.length === 4) {
      newArray[rowNumbers2[0]-1] = {...newArray[rowNumbers2[0] - 1], checkbox1: false, checkbox2: false, checkbox3: false, checkbox4: false};
      newArray[rowNumbers2[2]-1] = {...newArray[rowNumbers2[2] - 1], rowNumbers2: rowNumbers2, checkbox1: false, checkbox2: false, checkbox3: false, checkbox4: false};
    }
...
///////////////////////////////////
  sidingStyle = () => {
    ...
    this.state.inputField.map((field, i) => {
      //let style = {};
      if ((field.checkbox1 || field.checkbox2 || field.checkbox3 || field.checkbox4) && newArray[prevPrevField].type === "splitting") {
      ...
      if (field.type === "splitting" && field.sidingStyle.gridColumnStart === undefined && field.sidingStyle.gridColumn === undefined /*&& field.fieldNumber === this.state.inputField.length - 1*/ && (field.checkbox1 || field.checkbox3)) {
      ...
      if (field.type === "splitting" && field.sidingStyle.gridColumnStart === undefined && field.sidingStyle.gridColumn === undefined /*&& field.fieldNumber === this.state.inputField.length - 1*/ && (field.checkbox2 || field.checkbox4)) {
  ...
  render() {
    ...
    return (
      <div className="App">
          ...
          <div className="right">
              <SplittingRule iterator={this.operatorButton} ruleId={this.orderRules} order={this.state.ruleOrder} plusBtn={this.state.plusButtonMain} stateData={this.state.inputField} />
              <StackingRule iterator={this.operatorButton} ruleId={this.orderRules} order={this.state.ruleOrder} plusBtn={this.state.plusButtonMain} stateData={this.state.inputField} />
