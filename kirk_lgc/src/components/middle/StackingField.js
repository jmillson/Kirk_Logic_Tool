    ...
    const pipe2C = stateData.checkbox2Confirmed ? "✔" : "";
        ...
        return (
            <div className="wrapping" style={stateData.sidingStyle} >
                ...
                <div className="branchcloser" >{stateData.rowNumbers[3] === "cb1" ? <BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers} /> : <BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers2} />}</div>
                    ...
                    <div>
                        ...
                        <div className="branchcloser" >{stateData.rowNumbers[3] === "cb2" ? <BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers} /> : <BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers2} />}</div>
                        </div>
                        :
                        null
                    }
