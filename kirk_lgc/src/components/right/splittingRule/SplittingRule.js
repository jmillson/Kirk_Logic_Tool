...
export default function SplittingRule( {ruleId, order, plusBtn, stateData, iterator} ) {
    ...
    return (
        <>
            ...
            <div className={clickedNotClicked ? "rule-box rbone flash" : "rule-box rbone"} onClick={iterator} onMouseDown={() => ruleId(1)} style={lastClickedRule === 1 && plusBtn ? {background: "rgb(140, 240, 149)"} : {}} >
