    ...
    let whichCheckboxConf = null;
        ...
        return (
            <div className="wrapping" style={stateData.sidingStyle} >
                ...
                <div className="branchcloser" >{stateData.rowNumbers[3] === "cb1" ? <BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers2} /> : <BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers} />}
                                               {stateData.rowNumbers[3] === "cb2" ? <BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers} /> : <BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers2} />}</div>
                    ...
                    {(stateData.expanded && stateData.sidingStyle.gridColumnStart !== "unset") ?
                        <div>
                            ...
                            <div className="branchcloser" ><BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers2} />
