...
export default function FieldsTogether({
  ...
  stateData.map((type, i) => {
    ...
    if (type.type === "splitting") {
      ...
      if (
        type.sidingStyle.gridColumnStart === undefined &&
        type.sidingStyle.gridColumn === undefined
      ) {
        field.push(
          <SplittingField
            key={i}
        ...
        type.sidingStyle.gridColumn !== undefined &&
        type.sidingStyle.gridColumn.search("span 1") <= 0
      ) {
        ...
        field.push(
          <div
            ...
            style={{
              ...
              display: "grid",
              gridColumnStart: `${
                type.sidingStyle.gridColumnStart === "3" ? "3" : "1"
              }`,
              gridColumnEnd: `${
                type.sidingStyle.gridColumnEnd === "3" ? "3" : "5"
              }`,
            }}
          >
            <div
              style={
                type.sidingStyle.gridColumnStart === "3"
                  ? { display: "none" }
            ...
            <div
              style={
                type.sidingStyle.gridColumnStart === "1"
                  ? { display: "none" }
      ...
      if (
        ...
        type.sidingStyle.gridColumn === "1 / span 2" ||
        type.sidingStyle.gridColumn === "3 / span 2"
      ) {
        field.push(
          <div
            key={i}
