...
export default function StackingRule( {ruleId, order, plusBtn, stateData, iterator} ) {
    ...
    return (
        <>
            <h2>Stacking Rule</h2>
            <div className={clickedNotClicked ? "rule-box rbtwo flash" : "rule-box rbtwo"} onClick={iterator} onMouseDown={() => ruleId(2)} style={lastClickedRule === 2 && plusBtn ? {background: "rgb(140, 240, 149)"} : {}} >
