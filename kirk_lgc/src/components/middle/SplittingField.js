    ...
    let whichCheckboxConf = null;
        ...
        return (
            <div className="wrapping" style={stateData.sidingStyle} >
                ...
                <div className="branchcloser" >{stateData.rowNumbers[3] === "cb1" ? <BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers} /> : <BranchCloser checkBox={stateData.whichCheckbox} rowNumber={stateData.rowNumbers2} />}
                ...
                {stateData.expanded ?
                    ...
                    <div className="wrap splitting" onMouseUp={() => focus(stateData.fieldNumber)} >
                        ...
                        <div 
                            className="checkbox"
                            onClick={!stateData.checkbox3Confirmed ? () => checkboxClick3() : null}
                            style={style3}
